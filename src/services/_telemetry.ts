...
export interface TraceCtx {
  ...
  component?: 'talker' | 'talker_off_topic' | 'analyst' | 'analyst_online' | 'analyst_catchup' | 'orchestrator' | 'judge_dialog_naturalness' | 'judge_talker_grounding' | 'judge_slot_depth' | 'grounding_guard' | 'role_guard' | 'tester'
}
