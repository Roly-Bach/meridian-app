...
describe('analyzeConversationSignals → repeatedQuestionStem (KI-15)', () => {
  it('flags "Wie oft" repeated in the last 2 assistant turns', () => {
    ...
    expect(analyzeConversationSignals(makeCtx({ recentAssistantTurns })).repeatedQuestionStem).toBe('Wie oft')
  })
  ...
  it('flags "Wie lange" repeated in the last 2 assistant turns', () => {
    ...
    expect(analyzeConversationSignals(makeCtx({ recentAssistantTurns })).repeatedQuestionStem).toBe('Wie lange')
  })
  ...
  it('does NOT flag when the two most recent turns use different stems', () => {
    ...
    expect(analyzeConversationSignals(makeCtx({ recentAssistantTurns })).repeatedQuestionStem).toBeNull()
  })
  ...
  it('returns null for undefined or empty', () => {
    expect(analyzeConversationSignals(makeCtx()).repeatedQuestionStem).toBeNull()
    expect(analyzeConversationSignals(makeCtx({ recentAssistantTurns: [] })).repeatedQuestionStem).toBeNull()
  })
})
