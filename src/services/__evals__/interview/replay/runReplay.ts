    ...
    if (UPDATE_BASELINE || baseline === null) {
      ...
      const newBaseline: BaselineFile = {
        ...
        scores: {
          ...
          potenzialCoverage: scores.potenzialCoverage ?? 0,
          dedupPotenzialCoverage: scores.dedupPotenzialCoverage ?? 0,
          dependencyCapture: scores.dependencyCapture ?? 0,
          slotsPerTurn: scores.slotsPerTurn ?? 0,
          turnsToCompletion: scores.turnsToCompletion ?? 0,
