...
| PROJ-35 | interviewAgent.ts entkernen (Conversation-Signals + server-only-Naht) | Revision | Interview Engine | PROJ-22 | In Progress | [spec](interview-engine/PROJ-35-interviewagent-entkernen.md) | P2 | M | — |
