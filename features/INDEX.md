...
| PROJ-36 | ProcessStepsTable — Cluster-Aggregation als reines Modul | Revision | Dashboard & Output | PROJ-20 | In Progress | [spec](dashboard-output/PROJ-36-process-steps-table-cluster-aggregation.md) | P2 | S | — |
