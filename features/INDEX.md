...
| KI-9 | Medium | Talker-Halluzination wird von `hallucination_rate` nicht erfasst: Metrik greift nur auf Extraktions-/Schema-Ebene (evidence_quote-Kontamination), nicht auf konversationelle Faktentreue. Buchhalter-Lauf 2026-06-22 Turn 2: Agent erfand falsche Prämisse („Du hast vorhin 20 Rechnungen erwähnt") obwohl Persona in Turn 1 keine Zahl nannte — `hallucination_rate = 0` trotzdem. Falsches Vertrauen ins Signal. **Zweite Reproduktion 2026-06-23 Turn 13** ([Report](../docs/evals/interview/2026-06-23/2026-06-23-15-57-11-google-gemini-3-5-flash-buchhalter.md)): Agent sagt wortgleich das in `talkerPrompt.ts` Z.43 als VERBOTEN dokumentierte Beispiel ("Du hast vorhin 1200 Minuten erwähnt") — interne Tage→Minuten-Umrechnung eines anderen Prozesses fälschlich als Persona-Zitat ausgegeben. `hallucination_rate=0` weiterhin. | Eval 2026-06-22, 2026-06-23 | Eigenes Eval-Signal „Talker-Faktentreue gegen History" (Judge prüft Agent-Fragen gegen bisherige Persona-Aussagen) |
